      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate mb-5 pb-5 text-center text-md-left" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Vous emmène du point de départ souhaité jusquà l'aéroport</p>
          </div>
        </div>
      </div>
    </div>
...
Etapes à suivre : <br> 
<button type="button" class="btn btn-warning">1.</button> INDIQUEZ VOTRE ITINÉRAIRE 
<button type="button" class="btn btn-warning">2.</button> CONSULTEZ LE PRIX ET LA DISTANCE 
<button type="button" class="btn btn-warning">3.</button> CONFIRMEZ VOTRE RÉSERVATION
    		...
    		<div class="row">  
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>01</span> Réservation Rapide</h3>
    					<p>A la place d'aller chercher un moyen de transport pour aller vers l'aéroport, le client peut facilement réserver un moyen de transport utilisant quelques cliques.</p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>02</span> Prix raisonnables</h3>
    					<p>Les prix de la réservation sont très raisonnables, le client peut choisir le véhiculé souhaité selon ses contraintes financières et celles de confort. </p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>03</span> Sécurité et Relaxation</h3>
    					<p>En plus de ça, les services sont associés à la sécurité du client et au confort complet lors de son transfert de point de départ souhaité jusqu'à l'aéroport. </p>
    				</div>
    			</div>
    		</div>
    	</div>
...
<div class="icon"><span class="icon-map-marker"></span> Localiser les aéroports du Marrakech et Casablanca.</div>	 <br/>
...
<div class="icon"><span class="icon-road"></span> Donner plus de détails sur le temps d’arrivé et la durée entre l’aéroport et le point de départ choisi par notre client.</div>	<br/>
     ...
     <div class="col-md-7 text-center">
    	<div class="dropdown">
    		 <button class="btn btn-primary dropdown-toggle" style="width: 170% !important" type="button" data-toggle="dropdown">Question 2
  				<p> Est ce qu'il y a des chauffeurs "femmes" ? Je préfère être accompagnée par une femme   </p>   
			  <span class="caret"></span></button>
  				<textarea class="dropdown-menu" style="resize: none;" rows="4" cols="100%" disabled > Merci pour votre intérêt pour KechCasaAeroport "KCA". Pour l'instant, tous les chauffeurs sont des hommes, mais nous allons y réfléchir sérieusement. Nous vous tenons au courant dans les plus brefs délais.  </textarea>
		</div>
	</div>
     ...
     <div class="col-md-7 text-center">
    	<div class="dropdown">
    		 <button class="btn btn-primary dropdown-toggle" style="width: 170% !important" type="button" data-toggle="dropdown">Question 4
			  ...
			  <span class="caret"></span></button>
  				<textarea class="dropdown-menu" style="resize: none;" rows="4" cols="100%" disabled > envoyer votre CV à recrutement@KechCasaAeroport.com ,Notre équipe vous contactera en cas de nouvelles opportunités. </textarea>
		</div>
	</div>
     ...
     <div class="col-md-7 text-center">
    	<div class="dropdown">
    		 <button class="btn btn-primary dropdown-toggle" style="width: 170% !important" type="button" data-toggle="dropdown">Question 5
  				<p>  L'offre que vous proposez sur XX à 199 dh pour une navette one way : est-ce le prix par personne ou pour l'ensemble des voyageurs (nous serions 2) ? </p>   
			  <span class="caret"></span></button>
     ...
     <div class="col-md-7 text-center">
    	<div class="dropdown">
    		 <button class="btn btn-primary dropdown-toggle" style="width: 170% !important" type="button" data-toggle="dropdown">Question 6
  				<p> J'aimerais bien me renseigner à propos des tarifs de transfert de Ain chok vers l'aéroport International Mohammed V de Casablanca </p>   
			  <span class="caret"></span></button>
     ...
     <div class="col-md-7 text-center">
    	<div class="dropdown">
    		 <button class="btn btn-primary dropdown-toggle" style="width: 170% !important" type="button" data-toggle="dropdown">Question 9
  				<p>  le service à Agadir est disponible?  </p>   
			  <span class="caret"></span></button>
